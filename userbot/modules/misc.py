...
async def reedme(e):
    await e.edit(
        ...
        "\n[OpenUserBot's README.md file](https://github.com/aone-id/aone-kangbot/blob/sql-extended/README.md)"
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit(
        "Klik [Disini](https://github.com/yincen17/aone-kangbot) untuk Membuka Yincen aone-kangbot's GitHub page."
    )
