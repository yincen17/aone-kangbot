...
@register(outgoing=True, pattern="^.openbot(?: |$)(.*)")
...
CMD_HELP.update({
    'openbot':
    ".opengas\
\nUsage: Checks if the official Open userbot repository has any updates and shows a changelog if so.\
\n\n.opengas\
\nUsage: Updates your userbot, if there are any updates in the Official Open Userbot userbot repository."
})
